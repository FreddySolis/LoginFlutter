...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _form_log(){
    return Container(
      padding: EdgeInsets.only(top: 35.0, left: 25.0, right:25.0, bottom: 20.0),
      child: Column(
        children: <Widget>[
    ...
    return Container(
      child: Stack(
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.fromLTRB(28.0, 180.0, 0.0, 0.0),
            child: Text('There', 
            style: TextStyle(
              fontSize: 50.0, 
              fontWeight: FontWeight.bold)),
          ...
          Container(
            padding: EdgeInsets.fromLTRB(235.0, 150.0, 0.0, 0.0),
            child: Text('.',
